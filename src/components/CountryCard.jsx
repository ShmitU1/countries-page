...
import { setSelectedCountry } from '../app/features/selectedCountry'
...
const CountryCard = ({ country, index, setSelectedCountryID }) => {
    ...
    return (
        ...
        <div className='element_info_container'>
            ...
            {country.population ? <p className='info_content'><span>Population: </span>{country.population}</p> : ''}
            {country.region ? <p className='info_content'><span>Region: </span>{country.region}</p> : ''}
            {country.capital ? <p className='info_content'><span>Capital: </span>{country.capital}</p> : ''}
            </div>
        </div>
        </motion.div>
    )
