...
import { removeSelectedCountry } from "../lib/features/selectedCountry";
        ...
        <div>
          ...
          <div className="element_info_container">
            <div className="element_info_section element_info_section1">
              {nativeName && (
                <p className="info_section__element">
