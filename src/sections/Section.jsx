...
import data_country from '../constants/data.json'
...
const Section = () => {
  ...
  const selectedCountry = useSelector(state => state.selectedCountry.selectedCountryData)
  ...
  return (
    <main className={`main_section max-width-1440 ${mode}`}>
      ...
      {!selectedCountry && <section className={`section_container`}>
        {data
          .filter(country => 
